...
<body>
    <form action="session_proccess.php" method="POST">
        <input type="text" name="kolom_input_session1" required /><br>
        <input type="text" name="kolom_input_session2" required /><br>
        <button type="submit">Simpan</button>
    </form>

    <a href="session_proccess.php?proccess=hapus_session1"><button>Hapus Session 1</button></a><br>
    <a href="session_proccess.php?proccess=hapus_session2"><button>Hapus Session 2</button></a><br>
    <a href="session_proccess.php?proccess=hapus_semua_session"><button>Hapus Semua Session</button></a><br>
